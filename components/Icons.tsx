...
export const ShareIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <SvgIcon {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M7.217 10.907a2.25 2.25 0 11-3.184-3.184 2.25 2.25 0 013.184 3.184zm0 0l9.566-5.313m-9.566 7.499a2.25 2.25 0 10-3.184 3.184 2.25 2.25 0 003.184-3.184zm0 0l9.566 5.313m0-12.811a2.25 2.25 0 100 4.5 2.25 2.25 0 000-4.5z" />
  </SvgIcon>
);
